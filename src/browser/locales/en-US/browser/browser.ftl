...
browser-main-window-titles =
  ...
  .data-title-private = { -brand-full-name } Zetsu Mode
  .data-title-default-with-profile = { $profile-name } — { -brand-full-name }
  .data-title-private-with-profile = { $profile-name } — { -brand-full-name } Zetsu Mode
  .data-content-title-default = { $content-title } — { -brand-full-name }
  .data-content-title-private = { $content-title } — { -brand-full-name } Zetsu Mode
  .data-content-title-default-with-profile = { $content-title } — { $profile-name } — { -brand-full-name }
  .data-content-title-private-with-profile = { $content-title } — { $profile-name } — { -brand-full-name } Zetsu Mode
...
browser-main-window-titles-mac =
  ...
  .data-content-title-private = { $content-title } — Zetsu Mode
  .data-content-title-default-with-profile = { $content-title } — { $profile-name }
  .data-content-title-private-with-profile = { $content-title } — { $profile-name } — Zetsu Mode
...
private-browsing-shortcut-text-2 = { -brand-shortcut-name } Zetsu Mode
...
# This label should be written in all capital letters if your locale supports them.
browser-tab-audio-pip = MINIPLAYER
...
urlbar-result-action-search-in-private-w-engine = Search with { $engine } in Zetsu Mode
# Used when the private browsing engine is the same as the default engine.
urlbar-result-action-search-in-private = Search in Zetsu Mode
# The "with" format was chosen because the search engine name can end with
# "Search", and we would like to avoid strings like "Search MSN Search".
# Variables
#  $engine (String): the name of a search engine
...
private-browsing-indicator-label = Zetsu Mode
