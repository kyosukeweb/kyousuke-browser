...
list-empty-get-extensions-message =
    Get add-ons and themes on <a data-l10n-name="get-extensions">{ $domain }</a>
...
show-unsigned-extensions-button =
    .label = Some add-ons could not be verified

show-all-extensions-button =
    .label = Show all add-ons
...
detail-private-browsing-label = Run in Zetsu mode

# Some add-ons may elect to not run in private windows by setting incognito: not_allowed in the manifest.  This
# cannot be overridden by the user.
detail-private-disallowed-label = Not allowed in Zetsu mode
detail-private-disallowed-description2 = This add-on does not run while you’re in Zetsu mode. <a data-l10n-name="learn-more">Learn more</a>

# Some special add-ons are privileged, run in private windows automatically, and this permission can't be revoked
detail-private-required-label = Always allowed in Zetsu mode
detail-private-required-description2 = This add-on needs access to your online activities while you’re in Zetsu mode. <a data-l10n-name="learn-more">Learn more</a>

detail-private-browsing-on =
    .label = Allow
    .tooltiptext = Turn on in Zetsu mode

detail-private-browsing-off =
    .label = Don’t Allow
    .tooltiptext = Turn off in Zetsu mode
...
legacy-warning-show-legacy = Show legacy add-ons

legacy-extensions =
    .value = Legacy Add-ons

legacy-extensions-description =
    These add-ons do not meet current { -brand-short-name } standards so they have been deactivated. <label data-l10n-name="legacy-learn-more">Learn about the changes to add-ons</label>

private-browsing-description2 =
    { -brand-short-name } is changing how add-ons work in Zetsu mode. Any new add-ons you add to
    { -brand-short-name } won’t run by default in Zetsu mode. Unless you allow it in settings, the
    add-ons won’t work while you’re using Zetsu mode, and won’t have access to your online activities
    there. We’ve made this change to help keep your aura even more hidden.
    <label data-l10n-name="private-browsing-learn-more">Learn how to manage add-ons settings</label>

addon-category-discover = Recommendations
addon-category-discover-title =
    .title = Recommendations
addon-category-extension = Add-ons
...
extensions-warning-imported-addons2 =
    .message = Please finalize the installation of add-ons that were imported to { -brand-short-name }.
extensions-warning-imported-addons-button = Install add-ons
...
addon-manage-extensions-shortcuts = Manage add-on shortcuts
    .accesskey = S

shortcuts-no-addons = You don’t have any add-ons enabled.
shortcuts-no-commands = The following add-ons do not have shortcuts:
shortcuts-input =
...
discopane-intro2 =
    Add-ons and themes let you customize { -brand-product-name }. They can boost privacy,
...
discopane-notice-recommendations2 =
    .message =
        ...
        add-ons you’ve installed, profile preferences, and usage statistics.
...
install-postponed-message2 =
    .message = This add-on will be updated when { -brand-short-name } restarts.
...
addon-badge-private-browsing-allowed3 =
    .title = Allowed in Zetsu mode
addon-detail-private-browsing-help = When allowed, the add-on will have access to your online activities when you’re in Zetsu mode. <a data-l10n-name="learn-more">Learn more</a>
...
addon-detail-quarantined-domains-help = When allowed, the add-on will have access to sites restricted by { -vendor-short-name }. Allow only if you trust this add-on.
...
## This is the tooltip text for the recommended badges for an add-on in about:addons. The
## badge is a small icon displayed next to an add-on when it is recommended on AMO.

addon-badge-recommended3 =
  .title = { -brand-product-name } only recommends add-ons that meet our standards for security and performance
# We hard code "Mozilla" in the string below because the extensions are built
# by Mozilla and we don't want forks to display "by Fork".
addon-badge-line4 =
  .title = Official add-on built by Mozilla. Meets security and performance standards
addon-badge-verified3 =
  .title = This add-on has been reviewed to meet our standards for security and performance
...
addon-permissions-empty2 = This add-on doesn’t require any permissions.
...
recommended-extensions-heading = Recommended Add-ons
...
extension-heading = My Add-ons
theme-heading = My Themes
plugin-heading = My Plugins
dictionary-heading = My Dictionaries
locale-heading = My Languages
...
shortcuts-heading = Manage add-on shortcuts
