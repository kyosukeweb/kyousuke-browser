...
about-config-intro-warning-title = Be careful!!
about-config-intro-warning-text = Changing advanced options can impact { -brand-short-name } performance or security, or even break it!
