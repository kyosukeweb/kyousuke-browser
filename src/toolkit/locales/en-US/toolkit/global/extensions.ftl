...
webext-perms-sideload-text = Software on your computer installed an add-on that may affect your browser. Please review this add-on’s permissions requests and choose to turn it on or cancek (to leave it disabled).
