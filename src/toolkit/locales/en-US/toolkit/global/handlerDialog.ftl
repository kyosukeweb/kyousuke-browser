...
permission-dialog-description =
  Allow this website to open the { $scheme } link?
...
permission-dialog-description-app =
  Allow this website to open the { $scheme } link with { $appName }?
...
chooser-dialog-description = Choose an app to open the { $scheme } link.
...
choose-app-btn =
      .label = Choose…
      .accessKey = C
choose-other-app-window-title = Another app…

# Displayed under the name of a protocol handler in the Launch Application dialog.
choose-dialog-privatebrowsing-disabled = Disabled in Zetsu mode
