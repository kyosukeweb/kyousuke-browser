...
neterror-page-title = We couldn’t load the page
certerror-page-title = This page might be risky
certerror-sts-page-title = This page might be risky
neterror-blocked-by-policy-page-title = This page is blocked
neterror-captive-portal-page-title = Log in to network
neterror-dns-not-found-title = We couldn’t find this server
neterror-malformed-uri-page-title = This URL isn't valid
...
neterror-override-exception-button = Be brave and continue
neterror-pref-reset-button = Restore default settings
neterror-return-to-previous-page-button = Go back
neterror-return-to-previous-page-recommended-button = Go back (suggested)
